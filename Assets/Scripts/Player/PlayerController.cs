...
namespace Assets.Scripts.Player
{
    public class PlayerController : MonoBehaviour
    {
        ...
        private IEnumerator CalcScoreAndShowLoseMenu()
        {
            ...
            int moneyToEarn = moneyForMeters + _moneyForSpeed + _moneyForRisk;
            _userDataController.UserDataModel.EarnMoneyAndTrySetBestMetersRecord(_resultMeters, moneyToEarn);
